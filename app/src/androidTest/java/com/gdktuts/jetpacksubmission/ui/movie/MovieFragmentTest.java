...
public class MovieFragmentTest {
    ...
    @Test
    public void loadRecyclerMovieTest() {
        onView(withId(R.id.recylerviewMovieItem)).check(matches(isDisplayed()));
        onView(withId(R.id.recylerviewMovieItem)).check(new RecyclerViewItemCountAssertion(20));
    }

    @Test
    public void clickRecylerViewMovieTest() {
        onView(withId(R.id.recylerviewMovieItem)).check(matches(isDisplayed()));
